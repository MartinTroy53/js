...
/*
 ...
 1. Written without quotes (33 not "33"). If you do this JavaScript will treat it as string instead.
...
var amount = 23459.656123456789;

// toFixed() → returns a string, with the number written with a specified number of decimals
// console.log(amount.toFixed(2));

// toPrecision() → returns a number with a specified length
// console.log(amount.toPrecision(9));

// toString() → converts number to string

var convertNumberToString = age.toString();
